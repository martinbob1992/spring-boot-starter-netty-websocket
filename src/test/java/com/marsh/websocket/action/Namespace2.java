 ...
 */
@Slf4j
@NamespaceEndpoint(path = "/chat2")
public class Namespace2 extends SocketIOSupport {

    @OnConnect
    public void onConnect(SocketIOClient client){
        log.info("Namespace2 ---> 欢迎uid:"+client.getSessionId());
    }
    ...
    public void onDisconnect(SocketIOClient client){
        log.info("Namespace2 ---> 退出uid:"+client.getSessionId());
    }
}
